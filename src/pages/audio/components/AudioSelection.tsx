    ...
    <div id="audio" className="space-y-1 flex flex-col gap-4">
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-3">
          ...
          {/* Success message */}
          {showSuccess.input && (
            <div className="text-xs text-emerald-100 bg-emerald-500/10 border border-emerald-300/15 p-3 rounded-md">
          ...
          {devices?.input?.length === 0 && !isLoadingDevices && (
            <div className="text-xs text-violet-100 bg-violet-500/10 border border-violet-300/15 p-3 rounded-md">
              <strong>
